//
//  WPLineIndicatorSegmentedControl.h
...
@interface WPLineIndicatorSegmentedControl : UIControl
...
@property (nonatomic, strong) UIColor *textIndicatorColor; // default is [UIColor redColor]
